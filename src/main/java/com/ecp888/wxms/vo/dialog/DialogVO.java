...
public class DialogVO extends BaseVO{
	...
	public static DialogVO valueOf(String dialogId) {
		DialogVO dialogVO = new DialogVO();
		dialogVO.setDialogId(Integer.valueOf(dialogId));
		return dialogVO;
	}

	private static final long serialVersionUID = -5215845325560986907L;
	public static final String ATTACH_MOUDLE = "dialog";
	...
	public Integer getActStatus() {
		if(null == dialogStatus || !AppUtil.isNotEmpty(this.startDate) || !AppUtil.isNotEmpty(this.endDate)){
			return actStatus;
		}
