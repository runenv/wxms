package com.ecp888.wxms.vo.advert;
...
public class AdvertVO extends BaseVO{
	...
	public static AdvertVO valueOf(String advertId) {
		AdvertVO advertVO = new AdvertVO();
		advertVO.setAdvertId(Integer.valueOf(advertId));
		return advertVO;
	}

	private static final long serialVersionUID = -5215845325560986907L;
	public static final String ATTACH_MOUDLE = "advert";
	...
	private Integer advertStatus;//资讯状态
	...
	public Integer getActStatus() {
		if(null == advertStatus || !AppUtil.isNotEmpty(this.startDate) || !AppUtil.isNotEmpty(this.endDate)){
			return actStatus;
		}
		...
		if(this.advertStatus == 0){
			//pushStatus为“未发布”状态
			return ACTSTATUS_WAIT_INIT;
		}else if(this.advertStatus == 2){
			//pushStatus为“已撤销”状态
