package com.ecp888.wxms.vo.notice;
...
public class NoticeVO extends BaseVO{
	...
	public static NoticeVO valueOf(String noticeId) {
		NoticeVO noticeVO = new NoticeVO();
		noticeVO.setNoticeId(Integer.valueOf(noticeId));
		return noticeVO;
	}

	private static final long serialVersionUID = -5215845325560986907L;
	public static final String ATTACH_MOUDLE = "notice";
	...
	private String userName;//目标用户
	private String testUser;//测试用户
	private String targetUser;//目标用户,附件ID
	private Integer noticeStatus;//广告位状态
	
	private String noticeType;//广告位类型,数据字典值
	...
	public Integer getActStatus() {
		if(null == noticeStatus || !AppUtil.isNotEmpty(this.startDate) || !AppUtil.isNotEmpty(this.endDate)){
			return actStatus;
		}
	...
	/*public String getTargetUser() {
		if(null == targetUserList || targetUserList.isEmpty())return "";
		return targetUserList.toString().replace("[", "").replace("]", "");
	}*/
