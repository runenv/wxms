...
import cn.jpush.api.examples.ReportsExample;
...
//		testGetMessages();
	...
	public static void testGetReport() {
		...
		try {
            ReceivedsResult result = jpushClient.getReportReceiveds("783848360");
    ...
    public static void testGetMessages() {
        JPushClient jpushClient = new JPushClient(masterSecret, appKey);
        try {
            MessagesResult result = jpushClient.getReportMessages("783848360");
            LOG.debug("Got result - " + result);
